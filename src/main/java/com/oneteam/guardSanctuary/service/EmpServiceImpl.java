...
import com.oneteam.guardSanctuary.persistence.EmpDAO;
...
public class EmpServiceImpl implements EmpService {
	...
	public void signInAction(HttpServletRequest req, Model model) {
		...
		vo.setDept(req.getParameter("dept"));	// 부서
		vo.setPosition(req.getParameter("position"));	// 직급
		vo.setSalCode(Integer.parseInt(req.getParameter("salCode")));	// 호봉코드
		vo.setBank(req.getParameter("bank"));			// 은행명
		vo.setAccount(req.getParameter("account"));		// 계좌번호
		vo.setHireDate(req.getParameter("hireDate"));	// 입사일
		...
		// 직원등록 처리
		int insertCnt = dao.insertEmp(vo);
