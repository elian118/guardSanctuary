...
public class ClientDAOImpl implements ClientDAO {
	...
	public int insertClient(ClientVO vo) {
		return sqlSession.insert("com.oneteam.guardSanctuary.persistence.ClientDAO.insertClient", vo);
	}
	...
	public int selectKey(String key) {
		return sqlSession.selectOne("com.oneteam.guardSanctuary.persistence.ClientDAO.selectKey", key);
	}
	
	// 광회, 이메일 인증 완료 - 사용 가능(Enable : 1)
	@Override
	public int updateGrade(String key) {
		return sqlSession.update("com.oneteam.guardSanctuary.persistence.ClientDAO.updateGrade", key);
	}
	...
	public int idCheck(String strId) {
		...
		return sqlSession.selectOne("com.oneteam.guardSanctuary.persistence.ClientDAO.idCheck", strId);
	}
	...
	public int deleteClient(String strId) {
		return sqlSession.delete("com.oneteam.guardSanctuary.persistence.ClientDAO.deleteClient", strId);
	}
	
	// 광회, 회원정보 상세 페이지
	@Override
	public ClientVO getClientInfo(String strId) {
		return sqlSession.selectOne("com.oneteam.guardSanctuary.persistence.ClientDAO.getClientInfo", strId);
	}
